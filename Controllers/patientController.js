...
class PatientController {
    ...
    static async getUpcomingAppointments(req, res) {
        try {
            const { patient_id } = req.query;
            const result = await patientService.getUpcomingAppointments({ patient_id });
            res.status(200).json(result);
        } catch (error) {
            res.status(400).json({ error: error.message });
        }
    ...
    static async cancelAppointment(req, res) {
        try {
            ...
            const result = await patientService.cancelAppointment({ patient_id, appointment_id });
            res.status(200).json(result);
        } catch (error) {
            res.status(400).json({ error: error.message });
        }
    ...
    static async createAppointment(req, res) {
        try {
            ...
            const result = await patientService.createAppointment({ patient_id, doctor_id, appointment_date, purpose });
    ...
    static async getTestInterpretation(req, res) {
        try {
            ...
            const result = await patientService.getTestInterpretation({ patient_id, doctor_id, test_id });
            res.status(200).json(result);
        } catch (error) {
            res.status(400).json({ error: error.message });
        }
    ...
    static async requestTestInterpretation(req, res) {
        try {
            ...
            const result = await patientService.requestTestInterpretation({ patient_id, doctor_id, test_id });
            res.status(201).json(result);
        } catch (error) {
            res.status(400).json({ error: error.message });
        }
    ...
    static async createTicket(req, res) {
        try {
            ...
            const result = await patientService.createTicket({ patient_id, account_type, issue });
            res.status(201).json(result);
        } catch (error) {
            res.status(400).json({ error: error.message });
        }
